...
<body onmousewheel="wheel(event)"
	...
	<div class="rotatesection" style="width: 630px;" id="myDIV">
		<div class="blogcon">
			...
			<div class="flt" style="width: 100%; min-height: 230px;height: auto !important;">
				<div class="persooninfo"
					style="width: 105px; height: 90px; float: right; background: #eee; margin: 5px;">
					<div class="headimg" style="height: 60px; width: 90px;">
						<img src="img/dalai.jpg"
			...
			<div class="flt" style="width: 100%;margin:5px; height: auto !important;">
