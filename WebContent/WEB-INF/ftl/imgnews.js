...
function initPicPlayer(pics, w, h) {
	...
	p.text('');
	p
			.append('<div id=\"piccontent\" style=\"width:382px;height:330px;-webkit-writing-mode: vertical-lr;writing-mode: tb-lr;\"><div id="imgcontent" style=\"width:345px;height:310px;" ></div><div id="title" style="width:30px;color:#454545;height:330px;padding:5px;" class="mnlist"></div></div>');
	var c = $('#imgcontent');
	...
	// 按钮容器，绝对定位在右下角
	p.append('<div id=\"picbtnHolder\" style=\"position:absolute;top:' + (570)
